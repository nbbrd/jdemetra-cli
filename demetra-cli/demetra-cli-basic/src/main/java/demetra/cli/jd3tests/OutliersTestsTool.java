...
public interface OutliersTestsTool {
    ...
    @lombok.Data
    public static class OutliersTestsResults implements Record {
    ...
    @Nonnull
    OutliersTestsResults create(@Nonnull TsInformation info, @Nonnull Options options);
    ...
    public static OutliersTestsTool getDefault() {
        return Lookup.getDefault().lookup(OutliersTestsTool.class);
    }
}
