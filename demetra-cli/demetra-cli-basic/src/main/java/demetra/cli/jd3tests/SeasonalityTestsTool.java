...
public interface SeasonalityTestsTool {
    ...
    public static class SeasonalityTestsResults implements Record {
        ...
        private String name;
        private boolean seas;
        private StatisticalTest ftest, ftestami, kruskalwallis, friedman, qstest, ptest;
        ...
        public InformationSet generate() {
            ...
            if (qstest != null) {
                info.add("qstest", qstest);
            }
            if (ptest != null) {
                info.add("ptest", ptest);
            }
    ...
    @Nonnull
    SeasonalityTestsResults create(@Nonnull TsInformation info, @Nonnull Options options);
    ...
    public static SeasonalityTestsTool getDefault() {
        return Lookup.getDefault().lookup(SeasonalityTestsTool.class);
    }
}
