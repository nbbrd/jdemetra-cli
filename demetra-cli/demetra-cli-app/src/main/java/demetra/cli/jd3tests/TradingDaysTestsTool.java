...
public interface TradingDaysTestsTool {
    ...
    @Nonnull
    TradingDaysTestsResults create(@Nonnull TsInformation info, @Nonnull Options options);
    ...
    public static TradingDaysTestsTool getDefault() {
        return Lookup.getDefault().lookup(TradingDaysTestsTool.class);
    }
}
