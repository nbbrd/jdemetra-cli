 ...
 */
@ServiceProvider(service = OutliersTestsTool.class)
public final class OutliersTestslImpl implements OutliersTestsTool {

    @Override
    public OutliersTestsResults create(TsInformation info, Options options) {
        OutliersTestsResults result = new OutliersTestsResults();
