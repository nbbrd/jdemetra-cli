 ...
 */
public final class Ts2OutliersTests implements BasicCommand<Ts2OutliersTests.Parameters> {

    @CommandRegistration
    public static void main(String[] args) {
        BasicCliLauncher.run(args, Parser::new, Ts2OutliersTests::new, o -> o.so);
    }
    ...
    public static class Parameters {
        ...
        public OutliersTestsTool.Options spec;
    ...
    public void exec(Parameters params) throws Exception {
        ...
        List<InformationSet> output = OutliersTestsTool.getDefault().create(input, params.spec);
    ...
    static final class Parser extends JOptSimpleArgsParser<Parameters> {
        ...
        private final ComposedOptionSpec<OutliersTestsTool.Options> spec = new OutliersTestsOptionsSpec(parser);
    ...
    @NbBundle.Messages({})
    private static final class OutliersTestsOptionsSpec implements ComposedOptionSpec<OutliersTestsTool.Options> {

        public OutliersTestsOptionsSpec(OptionParser p) {
        }

        @Override
        public OutliersTestsTool.Options value(OptionSet o) {
            return new OutliersTestsTool.Options();
        }
    }
}
